  ...
  return (
    <div className='chatingroom-container'>
      ...
      <div className='chatingroom-topcontainer'>
        <img className="chattopcontainer-profileimg" src='./chatimg/Rectangle 17.png' alt="Profile Picture" />
        <span className='chattopcontainer-id'>Leechi</span>
        <img className="chattopcontainer-logout-btn"src='./chatimg/logout.svg'/>
      </div>

      <div className='chatingroom-chatcontents'>
        dd
      </div>
