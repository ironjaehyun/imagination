...
export const Leaderboard: LeaderboardEntry[] = [
  ...
  },
  {
    name: '물감으로 만든 화려한 바다',
    grade:
      '예술적인 이야기를 장황하게 설명하면 더 있어보이지 않을까? 라는 생각으로 만들어낸 우리의 작은 예술을 설명하는 글이 존재합니다.이걸 통해 우리는 어떤걸 알아볼 수 있을까요? 뻘소리? 예술? 아니면 비즈니스? 뭔가 말하 는게 재밌네요 이렇군 저렇군 1.5라인헤이트를 설정할거다 이겁니다.예술적인 이야기를 장황하게 명하면 더 있어보이지 않을까? 하는 그런 마음으로 열심히 이것저것 하고있...',
    score: 30,
